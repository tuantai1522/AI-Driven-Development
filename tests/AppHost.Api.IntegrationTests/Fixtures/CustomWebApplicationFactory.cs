...
public sealed class CustomWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    private static string FindApiProjectPath()
    {
        ...
        {
            var candidate = Path.Combine(current.FullName, "src", "AppHost.Api");
        ...
        throw new DirectoryNotFoundException("Could not locate 'src/AppHost.Api' from the current test execution directory.");
    }
}
